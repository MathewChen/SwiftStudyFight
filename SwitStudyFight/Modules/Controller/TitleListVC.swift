...
class TitleListVC: MXBaseViewController,UITableViewDelegate,UITableViewDataSource {
     ...
     */
    var titleArr : NSArray = ["Swift 基本语法","Swift 数据类型","Swift 变量","Swift 可选类型","Swift 常量","Swift 字面量","Swift 运算符","Swift 条件语句","Swift 循环","Swift 字符串","Swift 字符","Swift 数组","Swift 字典","Swift 函数","Swift 枚举","Swift 结构体","Swift 类","Swift 属性","一起来背单词吧"]
